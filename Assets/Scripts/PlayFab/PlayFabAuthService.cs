...
public class PlayFabAuthService
{
    ...
    {
        Debug.Log("Authenticating with Email & Password");
        //Check if the users has opted to be remembered.
        if (RememberMe && !string.IsNullOrEmpty(RememberMeId))
        {
            Debug.Log("Remember Me is checked, logging in with Custom ID: " + RememberMeId);
        ...
        Debug.Log("Authenticating with Email & Password: " + Email + " " + Password);
        ...
        PlayFabClientAPI.LoginWithEmailAddress(
            ...
            (LoginResult result) =>
            {
                ...
                if (RememberMe)
                {
                    ...
                    Debug.Log("Remember Me is checked, generating a new Custom ID: " + RememberMeId);
        ...
        SilentlyAuthenticate((LoginResult result) =>
            {
                ...
                Debug.Log("Adding Username & Password: " + Username + " " + Email + " " + Password);
                Debug.Log("Coalesced username: " + (Username ?? result.PlayFabId));
