...
public class OLDCustomCurve : Curve
{
    public OLDCustomCurve(OldCurveParameters parameters, CurvePoint startPoint, float yDeltaMin = 0, float yDeltaMax = 0)
    {
    ...
    public static List<CurvePoint> CurvePointsFromParameters(OldCurveParameters parameters, CurvePoint startPoint, float yDeltaMin = 0, float yDeltaMax = 0, float lengthMult = 1, float amplitudeMult = 1, float declineMult = 1)
    {
